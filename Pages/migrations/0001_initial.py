    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page_name', models.CharField(default='index', max_length=30, verbose_name='页面名称')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=25, verbose_name='名称')),
                ('herf', models.CharField(blank=True, max_length=100, null=True, verbose_name='相对路径')),
                ('superior', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='Pages.NavbarObject', verbose_name='上级栏目')),
            ],
            options={
                'verbose_name': '导航栏内容',
        ...
        migrations.CreateModel(
            name='Page_Type',
            fields=[
                ('page_name', models.CharField(max_length=30, primary_key=True, serialize=False, verbose_name='页面名称')),
